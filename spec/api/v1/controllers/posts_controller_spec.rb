...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "unauthenticated user" do
    it "PUT update returns http unauthenticated" do
      put :update, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Title", body: "Post Body Post Body Post Body Post Body"}
      expect(response).to have_http_status(401)
    end

    it "POST create returns http unauthenticated" do
      post :create, topic_id: my_topic.id, post: {title: "Post Title", body: "Post Body Post Body Post Body Post Body"}
      expect(response).to have_http_status(401)
    end
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      before { put :update, topic_id: my_topic.id, id: my_post.id, post: {title: @new_post.title, body: @new_post.body, topic: my_topic}}
